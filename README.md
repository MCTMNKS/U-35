...
Proje boyunca tamamlanması gereken backlog puanı 360'dır. İlk Sprint için bitirilmesi istenilen puan sayısı 100 olarak belirlenmiştir ancak bitirilen görevler kabul kriterlerini tam olarak karşılamadığı için puan 80 puana ulaşılmıştır. 
...
Kişisel yoğunluklar ve karşılaşılan teknik engeller gibi sebepler sonucu ve sprint esnasında oyun senaryosunun revize edilmesi sebebiyle planlanan işler ile gerçekleşen işler arasında çeşitli farklılıklar (Seviye tasarımındaki mantık aynı kalmıştır.) olmuştur. 
...
#### Geri Bildirim: 
Product owner tarafından sağlanan geri bildirime göre seviye tasarımı görevi oynanış bakımından sırıtmayacak bir şekilde tamamlanıp gelecek seviyelerin mekanikler ile birlikte geliştirilmesi takımın önceliği olmalıdır. Ayrıca iletişim konusunda takım arkadaşlarıma daily scrumda önceki günden ne kadar müsait olunacağı bildirilmesi de önem teşkil etmektedir.  
...
#### Olumsuz Gidenler:
  - Takım içi iletişim kopuklukları yaşandı. 
...
#### Özet ve Alınan Kararlar:
01/08/2024 tarihinde Discord platformu üzerinden son sprint’in değerlendirilmesi, gözden geçirilmesi ve projenin bütününün değerlendirilmesi yapılmıştır. Sprint Review’da -aşağıda da detaylıca açıklanmış olan- tamamlanan işler, planlanan ve gerçekleşen karşılaştırılması, sprint esnasında karşılaşılan engeller ve projenin son hali görüşülmüştür. Son sprint olması sebebiyle, ilerleyen zamanlar için herhangi bir karar alınmamıştır.
...
#### Planlanan ve Gerçekleşen: 
Kişisel yoğunluklar, takım içi iletişim ve koordinasyon problemleri, karşılaşılan teknik engeller gibi sebepler sonucu ve sprint esnasında görev dağılımının kesin ve net gerçekleştirilememesi sebebiyle planlanan işler ile gerçekleşen işler arasında çeşitli farklılıklar olmuştur. 
...
#### İyi Gidenler:
  ...
  - Başta planlanan projeye uygun (tasarım ve mekanikler açısından) bir ürün ortaya çıkarıldı. 

#### Olumsuz Gidenler:
  - Sprint başında görev dağılımı net bir şekilde yapılamadı.
  - Takım içi iletişim kopuklukları yaşandı. 
  - Takım toplantıları düzenli gerçekleştirilmedi. 
